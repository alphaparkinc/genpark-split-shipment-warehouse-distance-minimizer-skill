# genpark-split-shipment-warehouse-distance-minimizer-skill
...
**genpark-split-shipment-warehouse-distance-minimizer-skill** is a deterministic, zero-dependency Python skill engineered for intelligent merchant operations, supply chain logistics routing, and customer retention analytics.

> **Executive Capability**: 3PL fulfillment warehouse distance & split-shipment minimizer (Flexport / ShipBob)
...
result = client.optimize_fulfillment_split()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-split-shipment-warehouse-distance-minimizer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-split-shipment-warehouse-distance-minimizer-skill/mcp_server.py"]
    }
  }
}
```
