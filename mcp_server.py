                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency Merchant Operations & Supply Chain Commerce operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark Merchant Commerce Skill executed successfully."})
                    }
                ]
            }
        }
